...
| `beat_cc_median` | 1 | 4.217e-05 | 4.966e-05 | 5.006e-05 |
| `r_amp_err_pct` | 0 | 0.1214 | 0.1345 | 0.1429 |
...
| `psd_logdist` | 0 | 3.687 | 6.452 | 6.499 |
| `gain_bias` | 1 | 0.0001022 | 0.0002036 | 0.0002353 |
...
- **`psd_logdist` 의 floor 가 6.5 dB 로 매우 크다.** ECG 파워가 거의 없는 주파수 구간에서 log-PSD 차이가 폭발하기 때문이다. 따라서 `psd_logdist` 는 **절대값으로 해석하지 말고 방법 간 상대 비교로만** 쓴다. PSD 는 그림(F3)으로 보이는 것이 주 용도다.
