...
| 축 | 방식 | 왜곡 하한 [dB] | T 오차 | S 오차 | T-P 폭 |
|---|---|---:|---:|---:|---:|
| d0 | 블록 영위상 0.5 s | **20.3** | 0.2 %R | 0.5 %R | 7.6 %R |
| d0 | 중앙값 200+600 ms | **10.5** | 1.5 %R | 1.4 %R | 0.6 %R |
| d0 | 중앙값 100+300 ms | **6.6** | 16.4 %R | 1.9 %R | 0.4 %R |
| d1 | 블록 영위상 0.5 s | **21.8** | 0.7 %R | 0.0 %R | 7.2 %R |
| d1 | 중앙값 200+600 ms | **15.6** | 0.6 %R | 4.5 %R | 6.8 %R |
| d1 | 중앙값 100+300 ms | **13.8** | 0.9 %R | 5.4 %R | 6.8 %R |
