...
| `M02` | 10.44 ± 3.38 | 0.9479 ± 0.0365 | 27.32 ± 6.87 | 12.73 ± 6.89 | 0.9913 ± 0.0077 | 1.29 ± 2.19 | -1.25 ± 4.38 | 10.44 ± 2.02 | 0.0002 ± 0.0000 |
| `M03` | 9.99 ± 2.84 | 0.9489 ± 0.0476 | 29.77 ± 7.90 | 14.38 ± 10.73 | 0.9920 ± 0.0078 | 0.60 ± 1.21 | -1.11 ± 3.79 | 6.19 ± 2.71 | 0.0002 ± 0.0000 |
| `M04` | 12.24 ± 6.08 | 0.8574 ± 0.0766 | 36.56 ± 17.11 | 6.76 ± 5.25 | 0.9964 ± 0.0044 | 1.22 ± 2.10 | -1.24 ± 4.31 | 7.79 ± 5.79 | 0.0003 ± 0.0000 |
| `M05f` | 9.15 ± 2.96 | 0.9422 ± 0.0344 | 29.58 ± 8.12 | 9.91 ± 9.66 | 0.9900 ± 0.0087 | 1.26 ± 2.16 | -0.15 ± 3.82 | 5.38 ± 2.63 | 0.0337 ± 0.0138 |
| `M05` | 10.71 ± 3.31 | 0.9801 ± 0.0453 | 25.00 ± 7.48 | 10.51 ± 7.75 | 0.9930 ± 0.0056 | 1.18 ± 2.06 | -0.85 ± 3.43 | 6.70 ± 2.97 | 0.0405 ± 0.0134 |
| `M06` | 14.28 ± 3.01 | 1.0099 ± 0.0211 | 16.28 ± 9.37 | 4.94 ± 4.15 | 0.9926 ± 0.0142 | 0.22 ± 0.34 | -1.22 ± 4.52 | 4.24 ± 1.20 | 0.0016 ± 0.0001 |
| `M07` | 13.02 ± 2.72 | 1.0104 ± 0.0409 | 18.02 ± 7.95 | 5.89 ± 4.78 | 0.9916 ± 0.0126 | 0.26 ± 0.47 | -1.34 ± 4.25 | 4.76 ± 1.72 | 0.0027 ± 0.0001 |
| `M08` | 14.50 ± 3.05 | 1.0126 ± 0.0311 | 16.19 ± 8.56 | 4.80 ± 4.37 | 0.9941 ± 0.0120 | 0.24 ± 0.42 | -1.25 ± 4.21 | 4.80 ± 1.26 | 0.0019 ± 0.0001 |
| `B01` | 17.76 ± 5.15 | 0.9623 ± 0.0300 | 15.68 ± 6.63 | 4.29 ± 3.72 | 0.9986 ± 0.0015 | 0.20 ± 0.32 | -1.24 ± 4.17 | 2.69 ± 2.53 | 0.0004 ± 0.0000 |
| `B02` | 17.86 ± 6.70 | 0.9998 ± 0.0044 | 16.09 ± 5.67 | 8.18 ± 4.54 | 0.9933 ± 0.0044 | 1.17 ± 2.02 | -1.21 ± 4.39 | 7.89 ± 6.20 | 0.0004 ± 0.0000 |
| `M04np` | 12.24 ± 6.08 | 0.8574 ± 0.0766 | 36.56 ± 17.11 | 6.76 ± 5.25 | 0.9964 ± 0.0044 | 1.22 ± 2.10 | -1.24 ± 4.31 | 7.79 ± 5.79 | 0.0003 ± 0.0000 |
...
|---|---|---|---|---|---|
| `snr_imp_scaled` | `B01` | +4.903 | 4.77e-07 | 6.20e-06 | +1.000 |
| `snr_imp_scaled` | `B02` | +4.838 | 4.77e-07 | 6.20e-06 | +1.000 |
| `snr_imp_scaled` | `M08` | +1.629 | 3.01e-02 | 1.81e-01 | +0.526 |
| `snr_imp_scaled` | `M06` | +1.338 | 9.84e-02 | 4.92e-01 | +0.407 |
...
| `snr_imp_scaled` | `M_FE` | -0.921 | 1.21e-01 | 4.92e-01 | -0.383 |
| `snr_imp_scaled` | `M05` | -2.001 | 1.56e-02 | 1.09e-01 | -0.581 |
| `snr_imp_scaled` | `M02` | -2.194 | 2.13e-04 | 1.71e-03 | -0.834 |
| `snr_imp_scaled` | `M03` | -2.624 | 4.77e-07 | 6.20e-06 | -1.000 |
| `snr_imp_scaled` | `M05f` | -3.583 | 1.57e-05 | 1.42e-04 | -0.929 |
| `snr_imp_scaled` | `M00` | -10.474 | 4.77e-07 | 6.20e-06 | -1.000 |
| `qrs_dur_err_ms` | `M05` | +30.444 | 3.34e-05 | 4.01e-04 | +0.905 |
| `qrs_dur_err_ms` | `M00` | +15.224 | 6.53e-05 | 7.19e-04 | +0.881 |
| `qrs_dur_err_ms` | `M05f` | +14.674 | 5.04e-04 | 4.54e-03 | +0.794 |
| `qrs_dur_err_ms` | `M03` | +13.258 | 1.43e-06 | 1.86e-05 | +0.984 |
| `qrs_dur_err_ms` | `M07` | +10.875 | 9.87e-05 | 9.87e-04 | +0.866 |
| `qrs_dur_err_ms` | `M02` | +6.572 | 2.50e-03 | 1.75e-02 | +0.708 |
| `qrs_dur_err_ms` | `M06` | +4.747 | 1.45e-03 | 1.16e-02 | +0.739 |
| `qrs_dur_err_ms` | `M08` | +3.912 | 6.65e-03 | 3.99e-02 | +0.644 |
...
| `qrs_dur_err_ms` | `B01` | -2.294 | 3.01e-02 | 1.51e-01 | -0.526 |
...
|---|---|---|
| -5 dB | `B02`, `M06`, `B01`, `M08`, `M07` | `M04`, `M04np`, `M_FE`, `M00` |
| 0 dB | `B02`, `B01`, `M06`, `M08`, `M07` | `M03`, `M_FE`, `M00` |
| 5 dB | `B02`, `B01`, `M08` | `M03`, `M_FE`, `M00` |
| 10 dB | `B01`, `B02` | `M02`, `M03`, `M05f`, `M00` |
| 15 dB | `B01`, `B02` | `M07`, `M03`, `M02`, `M05`, `M05f`, `M00` |
| 20 dB | `B01`, `B02` | `M03`, `M07`, `M02`, `M05`, `M05f`, `M00` |
