...
| `M09` | 14.21 ± 3.18 | 0.0463 ± 0.0198 | 0.9780 ± 0.0262 | 0.99 ± 0.02 | 1.00 ± 0.01 | 2.60 ± 4.98 | 23.81 ± 12.40 * |
...
| `M05f` | 9.15 ± 2.96 | 0.9422 ± 0.0344 | 29.58 ± 8.12 | 9.91 ± 9.66 | 0.9900 ± 0.0087 | 1.26 ± 2.16 | -0.15 ± 3.82 | 5.38 ± 2.63 | 0.0249 ± 0.0107 |
| `M05` | 10.71 ± 3.31 | 0.9801 ± 0.0453 | 25.00 ± 7.48 | 10.51 ± 7.75 | 0.9930 ± 0.0056 | 1.18 ± 2.06 | -0.85 ± 3.43 | 6.70 ± 2.97 | 0.0299 ± 0.0106 |
| `M06` | 14.28 ± 3.01 | 1.0099 ± 0.0211 | 16.28 ± 9.37 | 4.94 ± 4.15 | 0.9926 ± 0.0142 | 0.22 ± 0.34 | -1.22 ± 4.52 | 4.24 ± 1.20 | 0.0016 ± 0.0001 |
| `M07` | 13.02 ± 2.72 | 1.0104 ± 0.0409 | 18.02 ± 7.95 | 5.89 ± 4.78 | 0.9916 ± 0.0126 | 0.26 ± 0.47 | -1.34 ± 4.25 | 4.76 ± 1.72 | 0.0025 ± 0.0001 |
| `M08` | 14.50 ± 3.05 | 1.0126 ± 0.0311 | 16.19 ± 8.56 | 4.80 ± 4.37 | 0.9941 ± 0.0120 | 0.24 ± 0.42 | -1.25 ± 4.21 | 4.80 ± 1.26 | 0.0018 ± 0.0001 |
| `B01` | 17.76 ± 5.15 | 0.9623 ± 0.0300 | 15.68 ± 6.63 | 4.29 ± 3.72 | 0.9986 ± 0.0015 | 0.20 ± 0.32 | -1.24 ± 4.17 | 2.69 ± 2.53 | 0.0003 ± 0.0000 |
| `B02` | 17.86 ± 6.70 | 0.9998 ± 0.0044 | 16.09 ± 5.67 | 8.18 ± 4.54 | 0.9933 ± 0.0044 | 1.17 ± 2.02 | -1.21 ± 4.39 | 7.89 ± 6.20 | 0.0003 ± 0.0000 |
| `M04np` | 12.24 ± 6.08 | 0.8574 ± 0.0766 | 36.56 ± 17.11 | 6.76 ± 5.25 | 0.9964 ± 0.0044 | 1.22 ± 2.10 | -1.24 ± 4.31 | 7.79 ± 5.79 | 0.0002 ± 0.0000 |
| `M09` | 14.13 ± 3.21 | 1.0167 ± 0.0291 | 17.00 ± 9.16 | 6.10 ± 7.33 | 0.9925 ± 0.0125 | 0.26 ± 0.47 | -1.46 ± 5.04 | 4.22 ± 1.36 | 0.0022 ± 0.0001 |
| `M10` | 13.60 ± 3.40 | 1.0294 ± 0.0373 | 17.27 ± 9.48 | 5.54 ± 5.57 | 0.9907 ± 0.0142 | 0.26 ± 0.47 | -1.42 ± 5.00 | 3.51 ± 1.25 | 0.0044 ± 0.0001 |
...
|---|---|---|---|---|---|
| `snr_imp_scaled` | `B01` | +4.903 | 4.77e-07 | 7.15e-06 | +1.000 |
| `snr_imp_scaled` | `B02` | +4.838 | 4.77e-07 | 7.15e-06 | +1.000 |
| `snr_imp_scaled` | `M08` | +1.629 | 3.01e-02 | 2.41e-01 | +0.526 |
| `snr_imp_scaled` | `M06` | +1.338 | 9.84e-02 | 6.89e-01 | +0.407 |
| `snr_imp_scaled` | `M09` | +1.181 | 1.37e-01 | 7.24e-01 | +0.368 |
...
| `snr_imp_scaled` | `M_FE` | -0.921 | 1.21e-01 | 7.24e-01 | -0.383 |
| `snr_imp_scaled` | `M05` | -2.001 | 1.56e-02 | 1.40e-01 | -0.581 |
| `snr_imp_scaled` | `M02` | -2.194 | 2.13e-04 | 2.13e-03 | -0.834 |
| `snr_imp_scaled` | `M03` | -2.624 | 4.77e-07 | 7.15e-06 | -1.000 |
| `snr_imp_scaled` | `M05f` | -3.583 | 1.57e-05 | 1.73e-04 | -0.929 |
| `snr_imp_scaled` | `M00` | -10.474 | 4.77e-07 | 7.15e-06 | -1.000 |
| `qrs_dur_err_ms` | `M05` | +30.444 | 3.34e-05 | 4.67e-04 | +0.905 |
| `qrs_dur_err_ms` | `M00` | +15.224 | 6.53e-05 | 8.49e-04 | +0.881 |
| `qrs_dur_err_ms` | `M05f` | +14.674 | 5.04e-04 | 5.55e-03 | +0.794 |
| `qrs_dur_err_ms` | `M03` | +13.258 | 1.43e-06 | 2.15e-05 | +0.984 |
| `qrs_dur_err_ms` | `M07` | +10.875 | 9.87e-05 | 1.18e-03 | +0.866 |
| `qrs_dur_err_ms` | `M02` | +6.572 | 2.50e-03 | 2.25e-02 | +0.708 |
| `qrs_dur_err_ms` | `M06` | +4.747 | 1.45e-03 | 1.45e-02 | +0.739 |
| `qrs_dur_err_ms` | `M10` | +4.675 | 3.59e-02 | 2.15e-01 | +0.510 |
| `qrs_dur_err_ms` | `M08` | +3.912 | 6.65e-03 | 5.32e-02 | +0.644 |
| `qrs_dur_err_ms` | `M09` | +3.533 | 3.91e-02 | 2.15e-01 | +0.502 |
...
| `qrs_dur_err_ms` | `B01` | -2.294 | 3.01e-02 | 2.11e-01 | -0.526 |
...
|---|---|---|
| -5 dB | `B02`, `M10`, `M06`, `M09`, `B01`, `M08`, `M07` | `M04`, `M04np`, `M_FE`, `M00` |
| 0 dB | `B02`, `B01`, `M06`, `M10`, `M08`, `M09`, `M07` | `M03`, `M_FE`, `M00` |
...
| `M09` | 9.75 | 15.91 | 11.13 | 13.85 | 13.12 | 12.04 | 17.15 |
