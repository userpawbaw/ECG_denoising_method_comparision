...
**→ 합쳤다** (UD-5 ②, 병합 커밋 `56c824f`): A 의 D-29·30·31 → **D-32·33·34**, A 의 F-46 → ~~**F-50**~~ → **F-46 으로 되돌림**(2026-09-18, 원본 합치기 — UD-5 ② 추기). 각 항목에 「번호 이력」을 남겼고 전사 `docs/41` 은 글자 그대로다. A 가 커밋한 `condpert8` 학습 둘은 완주 확인(history 47/47 · 44/44) 뒤 들어왔다.
