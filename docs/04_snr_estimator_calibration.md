...
|:-----------|-----------------:|------------------:|------------------:|-------:|
| awgn       |              0.7 |               0.9 |              -0.7 |    0.2 |
| bw         |              8.1 |              14.6 |              10.3 |    0.2 |
| em(motion) |              6.5 |               7.5 |              10.3 |    0.2 |
| impulse    |             -1.6 |              -0.4 |              10.2 |    0.2 |
| ma(emg)    |              0.4 |               0.4 |               7.5 |    0.2 |
| mixed      |              1.9 |               1.5 |               8   |    0.2 |
| pli        |              3.8 |               4.6 |              -1   |    0.2 |
...
| noise      |   (A) beat-resid |   (B) half-sample |   (C) isoelectric |   포화비율 |
|:-----------|-----------------:|------------------:|------------------:|-------:|
| awgn       |              0.4 |               0.7 |              -0.6 |    0.2 |
| bw         |             -0.9 |              -3.6 |              -2.4 |    0.9 |
| em(motion) |              0.8 |               0.6 |               4.6 |    0.4 |
| impulse    |             -1.8 |              -0.8 |               7.8 |    0   |
| ma(emg)    |              0.2 |               0.2 |               7.2 |    0.2 |
| mixed      |             -0.8 |              -1.6 |               6.4 |    0.3 |
...
|:-----------|-----------:|-------:|-------:|-------:|
| awgn       |       0.12 |   0    |   0.01 |   0    |
| bw         |       6.51 |   0.12 |   0.01 |   0.67 |
| em(motion) |       5.13 |   0.42 |   0.09 |   0.93 |
| impulse    |      -1.76 |   0.16 |   0.19 |   0.47 |
